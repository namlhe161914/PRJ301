...
public class Cart {
    ...
    private Book_HE161914 getBookById(int bid,List<Book_HE161914> list){
        for(Book_HE161914 i:list){
            if(i.getBid()==bid)
                return i;
        }
        return null;
    ...
    public Cart(String txt,List<Book_HE161914> list){
        items=new ArrayList<>();
        try{
        if(txt!=null && txt.length()!=0){
            ...
            for(String i:s){
                ...
                Book_HE161914 b=getBookById(bid, list);
